...
//            "distributed computing", "open-source", "developer", "startup", "fintech", "smart devices", "network security", "digital transformation");
    final List<String> technology = Arrays.asList("google", "microsoft", "ai", "apple", "ios", "samsung",
        "hardware", "amd", "capabilities", "technology",  "products", "launched");
...
//    );
    final List<String> entertainment = Arrays.asList(
            "wedding", "box", "actors", "cinematographer", "daughter", "karan", "hindi", "filmsfilms", "Hollywood","sensation"
    );
...
//    );
    final List<String> education = Arrays.asList(
        "exam", "enrollment", "candidates", "courses", "pg", "website", "teachers", "students", "research","university", "school","scholarships","study","learning"
...
//            "consumer behavior", "market trends", "sustainability", "corporate governance");
    final List<String> business = Arrays.asList(
       "cent", "equity", "shares", "profit", "stock", "rs", "crore", "merger", "sector", "investors","pay","bank","cdgd","xzvsv","cxczz","dsfdssg","sfdfas","dsfdsga","sffsgag"
    );
...
//        if (businessMatches >= sportsMatches && businessMatches >= techMatches && businessMatches >= educationMatches) {
//            return "Business";
//        }
...
//            return "Education";
//        }
//        if (educationMatches >= sportsMatches && educationMatches >= techMatches) {
//            return "Education";
//        }
...
//        }
//        if (entertainmentMatches >= sportsMatches && entertainmentMatches >= techMatches ) {
//            return "Entertainment";
//        }
